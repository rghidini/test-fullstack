package com.test.config.api.config;
...
@Configuration
@EnableJpaRepositories(basePackages = "com.test.model.api.repository",
...
public class DataSourceFactory {
	...
	public LocalContainerEntityManagerFactoryBean entityManagerFactory() throws NamingException {
		...
		factoryBean.setPackagesToScan(new String[] { "com.test.model.api.model" });
